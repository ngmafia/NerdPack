...
local Survival = {
	...
	{'Shield of the Righteous', '!talent(7,2)||spell.charges>2&{!player.debuff(Eye of Tyr)&!player.buff(Aegis of Light)&!player.buff(Ardent Defender)&!player.buff(Guardian of Ancient Kings)&!player.buff(Divine Shield)}', 'target' },
	...
	{'Hand of the Protector', 'player.health<40'},
