...
local virtues_blade={
	{{
		{{
			...
			{'Divine Storm', 'player.holypower>=5&{!talent(7,2)||spell(Crusade).cooldown>gcd*3}', 'target'},
		...
		{{
			...
			{'Divine Storm', 'player.area(6).enemies>=2&{spell(Wake of Ashes).duration<gcd*2||player.buff(Whisper of the Nathrezim).duration<gcd}&{!talent(7,2)||spell(Crusade).duration>gcd*4}', 'target' },
			...
			{'Templar\'s Verdict', '{spell(Wake of Ashes).duration<gcd*2||player.buff(Whisper of the Nathrezim).duration<gcd}&{!talent(7,2)||spell(Crusade).cooldown>gcd*4}', 'target', },
		}, 'player.holypower>=3'},
	...
	{'Blade of Justice', 'player.holypower<=2||{player.holypower<=3&{spell(Zeal).charges<=1.34||spell(Crusader Strike).charges<=1.34}}'},
	...
	{'Judgment', 'player.holypower>=3||{{spell(Zeal).charges<=1.67||spell(Crusader Strike).charges<=1.67}&spell(Blade of Justice).cooldown>gcd}||{talent(2,3)&target.health>50}', 'target'},
	...
	{{
		...
		{'Divine Storm', 'player.area(6).enemies>=2&player.buff(The Fires of Justice)&{!talent(7,2)||spell(Crusade).cooldown>gcd*3}'},
		...
		{'Divine Storm', 'player.area(6).enemies>=2&player.holypower>=4&{!talent(7,2)||spell(Crusade).cooldown>gcd*4}'},
		...
		{'Templar\'s Verdict', 'player.buff(The Fires of Justice)&{!talent(7,2)||spell(Crusade).cooldown>gcd*3}', 'target'},
		--actions.VB+=/templars_verdict,if=debuff.judgment.up&holy_power>=4&(!talent.crusade.enabled|cooldown.crusade.remains>gcd*4)
		{'Templar\'s Verdict', 'player.holypower>=4&{!talent(7,2)||spell(Crusade).cooldown>gcd*4}', 'target'},
	...
	{{
		...
		{'Templar\'s Verdict'},
	}, 'target.debuff(Judgment)&player.holypower>=3&{!talent(7,2)||spell(Crusade).cooldown>gcd*5}'},
}
